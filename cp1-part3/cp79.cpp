...
int main() {
    ...
    f1(ic,1,tt) {
        ...
        if (num%2==0) {
            ill x=n/4; // n/4 grps of 4 4 each 
            ...
            f0(i,0,num/2) {
                f0(j,0,num/2) {
                    ans[i][j]=arr[i];
                    ans[i][num-j-1]=arr[i+1];
                    ans[num-i-1][j]=arr[i+2];
                    ans[num-i-1][num-j-1]=arr[i+3];
                    i=i+4;
                }
            }
            ...
            ill t=num/2;
            ill x=(t*t)/4; // n/4 grps of 4 4 each 

            // int check=1;
            ill grp=0;

            for(auto x:mp) {
                grp=grp+(x.se/4); // max 4 grps 
            }
