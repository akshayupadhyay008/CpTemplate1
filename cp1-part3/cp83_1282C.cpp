        ...
        f0(i,0,num) {
            if (i==0) {
                ...
                if (time[i].fi!=time[i-1].fi) {
                    ...
                    ill total=a*easy + b*hard;
                    res=easy+hard;
                    if (total <= val)  {
                        ill rm=val-total;
                        // 2's 
                        ill twos=rm/a;
                        if (total_easy-easy <= twos) {
                            rm=rm-(a*(total_easy-easy));
                            res=res+total_easy-easy;
                            ill threes=rm/b;
                            if (total_hard - hard <= threes) {
                                res=res+total_hard-hard;
