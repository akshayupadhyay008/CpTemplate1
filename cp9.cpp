...
vector <ill> compress_me(ill arr[],ill num) { // 1 based me return 
    sort(arr,arr+num);
    vector <ill> comp(num+1);
    comp[0]=-1;
...
int main() {
    ...
    f1(ic,1,tt) {
        ...
        // vector <ill> comp = compress_me(presum,num+1);
