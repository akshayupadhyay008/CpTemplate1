...
int main() {
    ...
    f1(ic,1,tt) {
        ...
        vector <ill> form(num,intmax);

        // num-1 form 
        // lower bound se filled
        // vector <ill> used(num);
        multiset <ill> s;
        ...
        f0(i,0,num){
            if (form[i]==intmax) {
                ...
                if (it==s.end()) {
                    // none smaller or lower --> cannot do anything
                    break; // rest(aage) ke leye bhi same 
