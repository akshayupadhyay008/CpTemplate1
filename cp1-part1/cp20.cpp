...
//         f0(i,0,sz/2){
//             v=v+(2*min(gap[i],gap[gap.size()-1-i]));
//             // remo=remo+(gap[i] + gap[gap.size()-1-i] - (2*min(gap[i],gap[gap.size()-1-i]));
//         }
