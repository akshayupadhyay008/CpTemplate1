...
// class DSU { // 1 based index 
// public:
    
//     DSU(vector<ill> &parent,vector<ill> &sz,ill n){
//         for(int i=1;i<=n;i++){
//             parent[i]=i;
//             sz[i]=1;
//         }
...
//     ill find_parent(ill v,vector<ill> &parent){
//         if(parent[v]==v){
//             return v;
//         }
...
//     void union_set(ill a,ill b,vector<ill> &parent,vector<ill> &sz){
